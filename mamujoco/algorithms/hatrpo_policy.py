...
class HATRPO_Policy:
    ...
    def get_actions(self, cent_obs, obs, dynamics, rnn_states_actor, rnn_states_critic, masks, available_actions=None,
                    deterministic=False):
        """
    ...
    def evaluate_actions(self, cent_obs, obs, dynamics, rnn_states_actor, rnn_states_critic, action, masks,
    ...
    def act(self, obs, dynamics, rnn_states_actor, masks, available_actions=None, deterministic=False):
        """
        ...
        :param deterministic: (bool) whether the action should be mode of distribution or should be sampled.
        """
        actions, _, rnn_states_actor = self.actor(obs, dynamics, rnn_states_actor, masks, available_actions, deterministic)
